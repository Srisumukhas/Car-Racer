class Game {
  ...
  start() {
    ...
    car1.addImage("blastcar", blastImage)
    car2.addImage("blastcar", blastImage)
    cars = [car1, car2];
...
//save the value of player.life in temporary variable currentLife
var currentLife=allPlayers[plr].life
if(currentLife<=0){
  cars[index-1].changeImage("blastcar")
